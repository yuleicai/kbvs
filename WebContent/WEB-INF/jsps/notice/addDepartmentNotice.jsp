...
<html> 
	...
	<body>
		...
		<div class="container">
			<h5 class="dangqwz">当前位置：系统管理 ><a href="/admin/notice/module/list">公告管理 </a> > <span class="redspan">发布部门公告</span> </h5>
			<div class="syswhite yigebiao">
				<h4 class="biaoti">发布部门公告</h4>
				<hr class="clearFloat"/>
				<form class="form-horizontal" role="form" id="saveForm" action="/admin/notice/save" method="post">
					...
					<div class="form-group">
						...
						<div id="moduleSonList" class="col-sm-2">
