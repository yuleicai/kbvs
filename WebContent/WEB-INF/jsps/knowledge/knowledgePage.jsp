...
<html>
	...
	<body>
		...
		<div class="container">
			<h5 class="dangqwz">当前位置：系统管理 > <a href="/admin/knowledge/list" >知识管理</a> > <span class="redspan">知识详情</span> </h5>
			<div class="syswhite yigebiao">
				<h4 class="biaoti">知识详情</h4>
				<hr class="clearFloat"/>
				<form class="form-horizontal" role="form" action="/admin/knowledge/toEdit" id = "form1">
					...
					<hr />
					<c:if test="${knowledgeBean.type!=1}">
						<h2> 审核记录</h2>
						<div class="form-group">
				...
				<div class="form-group">
					<div class="col-sm-offset-2 col-sm-8">
						<button type="button" class="col-sm-offset-2 btn btn-default btn-width" onclick = "jQuery.knowledge.editCheck(this,'form1')">修改</button>
						<button type="button" class="col-sm-offset-3 btn btn-danger btn-width" onclick="jQuery.knowledge.deleteDetails(${knowledgeBean.id},${knowledgeBean.status})">删除</button>
					</div>
				</div>
